...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const recipesByCategory = {
        ...
        second: [
            ...
            { name: "Курочка с картошкой", description: "Нежное, сочное мясо, тушёное с мягкой картошкой и сладковатой морковью в ароматном островатом соусе. Блюдо согревает, насыщает и готовится без лишних хлопот.", image: "Рисунок15.png" },
            { name: "Фунчоза в китайском стиле", description: "Сочная курочка, нежная стеклянная лапша и яркий азиатский соус. Сладковатые нотки делают это блюдо настоящим взрывом вкуса — сытно, ароматно и безумно вкусно!", image: "Рисунок16.png" },
            { name: "Рис с курочкой", description: "Нежнейшее куриное филе в золотистой корочке, томлёное с имбирём, чесноком и мексиканской смесью, в густом устрично-соевом соусе. Подаётся на подушке из рассыпчатого басмати — сочно, ароматно!", image: "Рисунок17.png" },
            { name: "Рубленные котлетки", description: "Сочнейшие куриные котлетки с хрустящей корочкой и нежным плавленным сыром. Кусочки грудки, сыр, творожок и ароматная зелень создают идеальный баланс вкуса, а томаты добавляют сочность. Настоящее домашнее тепло в каждой котлетке!", image: "Рисунок21.png" }
        ],
        baking: [
        ...
        sweet: [
            ...
            { name: "Творожные синнабоны с греческим йогуртом", description: "Горячие, воздушные, с ароматной начинкой из корицы и тростникового сахара. Нежный крем из греческого йогурта слегка подтаивает на тёплой выпечке.", image: "Рисунок11.png" },
            ...
            { name: "Творожные оладьи", description: "Воздушные, как облако, и очень нежные. Сверху — дольки банана, которые оттеняют вкус и делают их ещё аппетитнее. Просто, легко и очень вкусно.", image: "Рисунок13.png" },
            { name: "Шоколадный клафути с вишней", description: "Тёплый десерт с нежной текстурой и насыщенным вкусом шоколада. Сочная вишня добавляет приятную кислинку. А если добавить шарик ванильного мороженого — получится идеальный контраст.", image: "Рисунок14.png" },
            { name: "Меренговый рулет", description: "Хрустящая меренга с нежной, тающей во рту сердцевиной. Ягодный конфитюр или свежие фрукты добавляют яркую кислинку и делают этот десерт настоящим произведением искусства — лёгкий, воздушный и невероятно изящный!", image: "Рисунок18.png" },
            { name: "Сырники с маком", description: "Нежные, воздушные сырники с хрустящей корочкой и бархатистой сердцевиной. Ароматный мак добавляет изысканную нотку и приятный хруст. Идеально со сметаной, ягодами или любым творожком!", image: "Рисунок20.png" }
        ],
        salads: [
        ...
        snacks: [
            { name: "Кабачки под сырной шапочкой", description: "Нежные кабачки, запечённые с сочными томатами и шапкой из расплавленного сыра. Простое, но невероятно вкусное блюдо, которое тает во рту — идеальный вариант для лёгкой закуски.", image: "Рисунок19.png" }
    ...
    const categoryOrder = ['first', 'second', 'sweet','baking', 'salads', 'drinks', 'snacks', 'preps'];
    const categoryNames = {
        first: 'Первое',
        second: 'Второе',
    ...
    if (recipeCard) {
        recipeCard.addEventListener('click', (e) => {
            ...
            if (currentRecipe) {
                ...
                else if (recipeName === 'Фунчоза в китайском стиле') targetPage = 'funchoza.html';
                ...
                else if (recipeName === 'Творожные синнабоны с греческим йогуртом') targetPage = 'sibinon.html';
                else if (recipeName === 'Шарлотка') targetPage = 'charlot.html';
                else if (recipeName === 'Творожные оладьи') targetPage = 'oladi.html';
                else if (recipeName === 'Шоколадный клафути с вишней') targetPage = 'claf.html';
                else if (recipeName === 'Курочка с картошкой') targetPage = 'nogki.html';
                else if (recipeName === 'Рис с курочкой') targetPage = 'ris-s-kurochkoy.html';
                else if (recipeName === 'Меренговый рулет') targetPage = 'merengovyy-rulet.html';
                else if (recipeName === 'Кабачки под сырной шапочкой') targetPage = 'kabachki.html';
                else if (recipeName === 'Сырники с маком') targetPage = 'syrniki-s-makom.html';
                else if (recipeName === 'Рубленные котлетки') targetPage = 'rublennye-kotletki.html';
