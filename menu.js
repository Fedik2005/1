...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const recipesByCategory = {
        ...
        sweet: [
            { name: "Мясная пицца", description: "Нежное филе грудки индейки, ароматный бекон и тягучая моцарелла на томатном соусе. Итальянские травы раскрывают каждый вкус, создавая идеальную гармонию. Настоящая мясная бомба!", image: "39.png" },
        ...
        recipeCard.addEventListener('click', (e) => {
            ...
            if (currentRecipe) {
                ...
                if (recipeName === 'Мясная пицца') {
                    ...
                    targetPage = 'recipe-default.html'; // страница-заглушка для остальных
                }
